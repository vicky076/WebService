...
Public Class ePlayWebService
    ...
    Public Function GetBulletin(ByVal Bul_Subject As String, ByVal Bul_IsVisible As String) As DataSet
        ...
        If Bul_IsVisible = "" Then
            If Bul_Subject = "" Then
                cmd.CommandText = "SELECT Bul_BulletinID,Bul_Subject,Bul_Content,Bul_StartDate,Bul_EndDate,Bul_CreateDate,Bul_CreateUID,Bul_IsVisible FROM [MyCard_CardService].[dbo].[swvw_GetAllBulletin] order by Bul_BulletinID desc"
            Else
                cmd.CommandText = "SELECT Bul_BulletinID,Bul_Subject,Bul_Content,Bul_StartDate,Bul_EndDate,Bul_CreateDate,Bul_CreateUID,Bul_IsVisible FROM [MyCard_CardService].[dbo].[swvw_GetAllBulletin] where Bul_Subject like '%" & Trim(Bul_Subject) & "%' order by Bul_BulletinID desc"
            End If
        Else
            If Bul_Subject = "" Then
                cmd.CommandText = "SELECT Bul_BulletinID,Bul_Subject,Bul_Content,Bul_StartDate,Bul_EndDate,Bul_CreateDate,Bul_CreateUID,Bul_IsVisible FROM [MyCard_CardService].[dbo].[swvw_GetAllBulletin] where Bul_IsVisible=@Bul_IsVisible order by Bul_BulletinID desc"
                ...
                End If
            Else
                cmd.CommandText = "SELECT Bul_BulletinID,Bul_Subject,Bul_Content,Bul_StartDate,Bul_EndDate,Bul_CreateDate,Bul_CreateUID,Bul_IsVisible FROM [MyCard_CardService].[dbo].[swvw_GetAllBulletin] where Bul_Subject like '%" & Trim(Bul_Subject) & "%' and Bul_IsVisible=@Bul_IsVisible order by Bul_BulletinID desc"
                If Bul_IsVisible = 1 Then
                    cmd.Parameters.Add("@Bul_IsVisible", SqlDbType.Bit).Value = True
                Else
                    If Bul_IsVisible = 0 Then
    ...
    Public Function swsp_AddNewBulletin(ByVal Bul_Subject As String, ByVal Bul_Content As String, ByVal Bul_StartDate As DateTime,
        ...
        Dim com As New SqlClient.SqlCommand("MyCard_CardService.dbo.swsp_AddNewBulletin", conn)
    ...
    Public Function swsp_UpdateBulletin(ByVal Bul_BulletinID As Integer, ByVal Bul_Subject As String, ByVal Bul_Content As String, ByVal Bul_StartDate As DateTime,
        ...
        Dim com As New SqlClient.SqlCommand("MyCard_CardService.dbo.swsp_UpdateBulletin", conn)
        com.CommandType = CommandType.StoredProcedure
        com.CommandTimeout = 300
    ...
    Public Function swsp_DeleteBulletin(ByVal Bul_BulletinID As Integer, ByVal Bul_CreateUID As Integer) As ReturnValue
        ...
        Dim com As New SqlClient.SqlCommand("MyCard_CardService.dbo.swsp_DeleteBulletin", conn)
        com.CommandType = CommandType.StoredProcedure
        com.CommandTimeout = 300
    ...
    Public Function EMS_CS_Ad_Group_Insert(ByVal GroupName As String, ByVal CreateUser As String) As ReturnValue
        ...
        Dim com As New SqlClient.SqlCommand("MyCard_CardService.dbo.EMS_CS_Ad_Group_Insert", conn)
        com.CommandType = CommandType.StoredProcedure
        com.CommandTimeout = 300
    ...
    ''' </remarks>
    <WebMethod()> _
    Public Function EMS_CS_Ad_Group_Update(ByVal GroupSn As Integer, ByVal GroupName As String, ByVal UserStamp As String) As ReturnValue
        ConnStr(19)

        Dim com As New SqlClient.SqlCommand("MyCard_CardService.dbo.EMS_CS_Ad_Group_Update", conn)
        com.CommandType = CommandType.StoredProcedure
        com.CommandTimeout = 300
    ...
    Public Function EMS_Ad_Group_Query(ByVal Name As String) As DataSet
        ...
        Dim Sql As String
        If Name <> "" Then
            Sql = "SELECT Sn,Name, CreateUser , UserStamp , CreateDate ,DateStamp  FROM [MyCard_CardService].[dbo].[View_EMS_Ad_Group]  Where Name like '%" & Name & "%' ORDER BY Name,CreateDate"
        Else
            Sql = "SELECT Sn,Name, CreateUser , UserStamp , CreateDate ,DateStamp  FROM [MyCard_CardService].[dbo].[View_EMS_Ad_Group]   ORDER BY Name,CreateDate"
        End If
        cmd.CommandText = Sql
